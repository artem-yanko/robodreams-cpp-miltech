...
APP_BIN="${APP_BIN:-${REPO_DIR}/build/debug/homework_11/homework_11_app}"
CHECKER_BIN="${CHECKER_BIN:-${REPO_DIR}/homework_11/data/checker/checker_pi_arm64}"
UART_DEVICE="${UART_DEVICE:-/tmp/ttyA}"
CHECKER_UART="${CHECKER_UART:-/tmp/ttyH}"
SIM_BANK="${SIM_BANK:-/tmp/hw11-sim-bank}"
OUTPUT_DIR="${OUTPUT_DIR:-${REPO_DIR}/homework_11/results}"
