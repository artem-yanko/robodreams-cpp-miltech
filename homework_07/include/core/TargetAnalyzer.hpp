...
public:
    ...
    bool selectBestTarget(BestTargetResult& result, const DroneConfig& config, const DroneMotionState& droneMotion, bool isTurning, bool isMoving, bool isDecelerating, bool isAccelerating, const Coord& dronePosition, const ITargetProvider& targets, const BallisticsResult& ballistics, double acceleration, bool returningFromManuver);
};
